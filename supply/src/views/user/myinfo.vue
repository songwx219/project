...
export default {
  ...
  data () {
    return {
        modifyState:false,
        userdata:{"id":1,"sid":1,"company":"北京是个啥科技有限公司","logo":"/upload/1567396623155logo.png","username":"李菲菲1","phone":"15678945612","tel":"010-12345678","email":"lifeifie@email.com","fax":"010-123456788","address":"北京市丰台区南三环麦子街道幸福大厦1234室","status":"1"},
        modifyData:{},
