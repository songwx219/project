  ...
  export default {
    ...
    data () {
      return {
          ...
          menuData:[
            {class:'产品管理',msg:[
                {name:'新增产品',url:'/product',icon:'el-icon-plus'},
                {name:'批量上传',url:'/',icon:'el-icon-upload2'},
                {name:'产品编辑',url:'/',icon:'el-icon-edit-outline',child:[{name:'在售商品',url:'/'},{name:'已下架商品',url:'/'},{name:'库存警告商品',url:'/'}]}
            ]},
            {class:'订单管理',msg:[
                {name:'我的订单',url:'/',icon:'el-icon-s-order',child:[{name:'全部订单',url:'/'},{name:'待发货订单',url:'/'},{name:'待完成订单',url:'/'},{name:'已完成订单',url:'/'}]},
                {name:'财务对账',url:'/',icon:'el-icon-s-finance',child:[{name:'全部对账单',url:'/'},{name:'已发货对账单',url:'/'},{name:'已收款对账单',url:'/'},{name:'已开票对账单',url:'/'}]}
            ]},
            {class:'系统管理',msg:[
                {name:'个人中心',url:'/',icon:'el-icon-user',child:[{name:'个人信息',url:'/user/detail'},{name:'修改密码',url:'/user/resetpwd'}]},
