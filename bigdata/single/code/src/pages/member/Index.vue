<template>
  <div class="container">
    <div class="header">
      <div class="left">sunny的管理平台</div>
      <div class="middle">
        <ul>
          <li class="l"><router-link to="/"><i class="fa fa-home"></i> 首页</router-link></li>
          <li class="l"><router-link to="Member"><i class="fa fa-user"></i> 人员</router-link></li>
          <li class="r"><router-link to="Store"><i class="fa fa-shopping-bag"></i> 门店</router-link></li>
          <li class="l"><router-link to="item.href">用户</router-link></li>
          <li class="r"><router-link to="item.href">用户</router-link></li>
          <li class="l"><router-link to="item.href">用户</router-link></li>
          <li class="r"><router-link to="item.href">用户</router-link></li>
          <li class="l"><router-link to="item.href">用户</router-link></li>
          <li class="r"><router-link to="item.href">用户</router-link></li>
      ...
      <div class="right">
        <strong>你好，<b class="c_b">admin</b>！<i class="fa fa-caret-down"></i></strong>
